...
import { errorOptions } from '@ra-lib/ajax';
...
function getErrorTip(error: any, tip: string | boolean | undefined) {
...
export default function handleError({ error, tip, options = {} }: errorOptions) {
